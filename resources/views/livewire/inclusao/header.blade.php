<div >
    ...
    class="navbar border default-layout col-lg-12 col-12 fixed-top d-flex align-items-top flex-row">
        <div style="background: #f4f5f7" class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
            <div class="me-3">
